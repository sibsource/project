Шаблон backend/frontend проекта на Dajngo
=========================================

Шаблон проекта. Реализована компиляция SCSS, сборка и минификация JS и CSS, 
предварительная проверка CSS lint, JSCS, ESLint.
